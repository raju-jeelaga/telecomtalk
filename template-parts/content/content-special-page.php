...
<?php
$tct_sp_fields = get_post_meta( get_the_ID(), 'telecomtalk_special_fields', true );
if($tct_sp_fields['enable_sp_fields'] == 1){
?>
<div class="oi-post-highlight-block" id="oi-post-highlight-block">
	<div class="oi-post-highlight">
		<div class="oi-post-highlight-title"><?php echo $tct_sp_fields['tct_sp_title'];?></div>
		<div class="oi-post-highlight-links">
			<ul>
				<?php
				for( $i=1;$i<=5;$i++){
					if( !empty($tct_sp_fields['tct_sp_txt_'.$i]) && !empty($tct_sp_fields['tct_sp_link_'.$i])){
					?>
					<li><a href="<?php echo $tct_sp_fields['tct_sp_link_'.$i];?>" class="highlights_back"><?php echo $tct_sp_fields['tct_sp_txt_'.$i];?></a></li>
					<?php
					}
				}
				?>
	...
	<div class="oi-post-highlight-seperator"></div>
	<div class="oi-post-highlight-desc">
		<p><?php echo $tct_sp_fields['tct_special_content'];?></p>
	</div>
</div>
<?php
}
